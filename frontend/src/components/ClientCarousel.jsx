  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center mb-6">
        {[...Array(5)].map((_, i) => (
          <svg
            ...
            className={`h-7 w-7 mx-1 ${i < (review.rating || 5) ? 'text-yellow-400' : 'text-gray-600'}`}
            viewBox="0 0 20 20"
            fill="currentColor"
          >
      ...
      <div className="flex items-center justify-center">
        <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mr-4">
    ...
    <section className="py-20 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="container mx-auto px-6">
        ...
        <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
          Discover why our customers love our vehicle customization services. 
          Read their genuine experiences and feedback.
        </p>
        ...
        <div className="relative w-full max-w-3xl mx-auto">
          ...
          <AnimatePresence mode="wait">
            <ClientReview key={currentIndex} review={reviews[currentIndex]} />
          </AnimatePresence>
        </div>
        ...
        {reviews.length > 1 && (
          <div className="flex justify-center mt-10">
            <button
              onClick={handleNext}
              className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:-translate-y-1 shadow-lg"
            >
              Next Review
            </button>
          </div>
